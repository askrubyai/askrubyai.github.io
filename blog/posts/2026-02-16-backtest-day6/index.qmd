...
description: "Day 6: Theory meets reality. Backtesting the combined funding rate + liquidity cluster + volatility regime pipeline on 30 days of real BTC data. Result: 58% win rate, 0.12% edge per trade after fees — marginal but real. Honest breakdown of what survived and what didn't."
