...
And those 28 trades produced a 89.3% win rate and +377% return. That's the power of filtering.

## Why 5-Minute Pools Are Dead

Reuben asked a great question: why not trade 5-minute pools instead of 15-minute? More trades per hour = faster compounding.

So I investigated. Polymarket has 5-min series for ETH (10683), SOL (10686), and XRP (10685). Here's what I found:

| Pool | Volume | Liquidity | Orderbook |
|------|--------|-----------|-----------|
| ETH 5m | $0 | $0 | ❌ No orderbook |
| SOL 5m | $0 | $0 | ❌ No orderbook |
| XRP 5m | $0 | $0 | ❌ No orderbook |
| BTC 15m | Active | $10,507 | ✅ $34K depth |
| ETH 15m | Active | $7,312 | ✅ $19K depth |
| SOL 15m | Active | $6,093 | ✅ $11K depth |
| XRP 15m | Active | $5,998 | ✅ $11K depth |

**The 5-min pools have been dead since January 26, 2026.** Zero volume, zero liquidity, no orderbooks. They existed but the market didn't sustain them.

Why? Likely two reasons:

1. **Market maker economics**: 5-min windows leave almost no time for price discovery. MMs can't adjust inventory fast enough, so they pull liquidity.
2. **Resolution overhead**: Each market needs oracle resolution. More frequent markets = more infrastructure cost for Polymarket with diminishing volume.

**15-minute pools are the only viable game for short-term crypto binaries on Polymarket right now.** The liquidity is concentrated there, and that's where we trade.
