...
description: "A simple regime detector that identifies post-spike VRP windows where the edge expands 5-10×. Combining threshold rules with exponential smoothing to know WHEN to trade binary options."
image: regime-detector-diagram.png
